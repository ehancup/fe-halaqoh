...
import { AddMusrifPayload } from "@/lib/musrif/interface";
...
const Page = () => {
    ...
    const {useAddMusrif} = useMusrifModule();
    const {mutate, isPending} = useAddMusrif()
  const formik = useFormik<AddMusrifPayload>({
    initialValues: addSantriSchema.getDefault(),
    validationSchema: addSantriSchema,
    enableReinitialize: true,
    onSubmit: (value: AddMusrifPayload) => {
        console.log(value);
        mutate(value, {
